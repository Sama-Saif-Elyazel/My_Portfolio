    ...
    return (
        <div className='bg-[#ecd7ef] min-h-screen w-full flex flex-col items-center justify-center pt-28 pb-16 px-6 relative overflow-x-hidden scroll-mt-24' id='about'>
            ...
            <div className='relative z-10 w-full max-w-5xl mx-auto flex flex-col items-center gap-10'>
                ...
                <h1 className='text-4xl sm:text-5xl md:text-6xl font-bold text-[#d4b0de] font-[cursive] drop-shadow-md text-center'>
                    About Me
                </h1>
                ...
                <div className='bg-white/40 backdrop-blur-md border border-white/60 rounded-3xl p-8 md:p-12 shadow-2xl hover:shadow-[#4c0a5e]/20 transition-all duration-500 w-full flex flex-col md:flex-row items-center justify-between gap-10'>
                    ...
                    <div className='flex flex-col justify-center items-center md:items-end text-center md:text-right gap-4 max-w-xl'>
                        ...
                        <p className='text-base sm:text-2lg text-[#680b82] leading-relaxed font-semibold pt-2'>
                            🎓 I'm currently a second-year Information Technology student at the Egyptian E-Learning University (EELU)
                        </p>

                        <p className='text-base sm:text-lg text-[#2f053a] leading-relaxed font-semibold pt-2'>
                            💡 I enjoy building responsive websites, analyzing data, and learning modern technologies. I'm always looking for opportunities to improve my skills through projects and continuous learning. <br />
                           🚀 who develops impactful web applications and uses data to solve real-world problems.
                        </p>
                    </div>
