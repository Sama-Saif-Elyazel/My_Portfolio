...
export default function About() {
    return (
        <>
            <div className='bg-[#ecd7ef] min-h-screen w-full relative flex flex-col items-center justify-center overflow-x-hidden max-w-full scroll-mt-24 py-5 px-0 pt-0' id='about'>
                ...
                <div className='relative z-10 w-full max-w-7xl mx-auto flex flex-col items-center gap-12 px-6 lg:px-12'>
                    ...
                    <div className='flex flex-row md:flex-row items-center justify-center md:justify-between gap-10 md:gap-16 lg:gap-15 w-full px-0 md:px-0 my-auto'>
                       
                        <div className='w-60 h-80 sm:w-72 sm:h-60 md:w-50 md:h-110 shrink-0 overflow-hidden rounded-full shadow-2xl border-4 border-[#e1c8e9] '>
